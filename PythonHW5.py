...
user_input = int(input('Сколько пословиц вы хотите сгенерировать? '))
...
while True:
    ...
    # Заменяем 'Ум' на variant, учитывая разные регистры
    new_proverb = proverb.replace('Ум', variant).replace('ум', variant)
